...
@app.command("info")
def info(
    key: Annotated[str, typer.Argument(help="Urkunden-Key (aus Urkundensuche)")],
    api_key: Annotated[
    ...
    Beispiele:
        ...
        firmenbuchat urkunde info "304188_0070711322495_000___000_30_7730290_XML"
    """
...
def download(
    ...
    output_path: Annotated[
        Path | None, typer.Option("--output", "-o", help="Ausgabepfad (Standard: automatisch)")
    ] = None,
    api_key: Annotated[
        str | None, typer.Option("--api-key", "-k", envvar="FIRMENBUCH_API_KEY", help="API-Key")
    ] = None,
    ...
    Beispiele:
        ...
        firmenbuchat urkunde download "304188_..._PDF"

        firmenbuchat urkunde download "304188_..._PDF" -o jahresabschluss.pdf
    """
    api = resolve_api_key(api_key)
