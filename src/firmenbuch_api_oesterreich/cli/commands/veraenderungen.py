...
def firmen(
    von: Annotated[
        datetime | None,
        typer.Option(
            "--von", "-v", formats=["%Y-%m-%d"], help="Startdatum (Standard: vor 7 Tagen)"
        ),
    ] = None,
    bis: Annotated[
        datetime | None,
        typer.Option("--bis", "-b", formats=["%Y-%m-%d"], help="Enddatum (Standard: heute)"),
    ] = None,
    gericht: Annotated[
        str | None, typer.Option("--gericht", "-g", help="3-stellige Gerichtsnummer")
    ] = None,
    rechtsform: Annotated[
        str | None, typer.Option("--rechtsform", "-r", help="Rechtsform (z.B. AG, GES)")
    ] = None,
    api_key: Annotated[
    ...
    limit: Annotated[int, typer.Option("--limit", "-l", help="Max. Anzahl Ergebnisse")] = 100,
    ...
    Beispiele:
        ...
        firmenbuchat veraenderungen firmen -g 007 -r AG
    """
...
def urkunden(
    ...
    Beispiele:
        ...
        firmenbuchat veraenderungen urkunden
