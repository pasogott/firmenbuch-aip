...
def auszug(
    ctx: typer.Context,
    fnr: Annotated[str, typer.Argument(help="Firmenbuchnummer mit Prüfbuchstabe (z.B. 160573m)")],
    stichtag: Annotated[
        datetime | None,
        typer.Option(
            "--stichtag", "-s", formats=["%Y-%m-%d"], help="Stichtag (YYYY-MM-DD), Standard: heute"
        ),
    ] = None,
    umfang: Annotated[
        str,
        typer.Option(
            "--umfang", "-u", help="Umfang: Kurzinformation, aktueller Auszug, historischer Auszug"
        ),
    ] = "Kurzinformation",
    api_key: Annotated[
