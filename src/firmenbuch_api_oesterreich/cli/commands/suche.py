...
@app.command("firma")
def firma(
    suchbegriff: Annotated[str, typer.Argument(help="Suchbegriff (mit * für Wildcards)")],
    suchbereich: Annotated[
        int, typer.Option("--bereich", "-b", min=1, max=6, help="Suchbereich 1-6")
    ] = 1,
    exakt: Annotated[
        bool, typer.Option("--exakt", "-e", help="Exakte Suche (sonst phonetisch)")
    ] = False,
    gericht: Annotated[
        str | None, typer.Option("--gericht", "-g", help="3-stellige Gerichtsnummer")
    ] = None,
    rechtsform: Annotated[
        str | None, typer.Option("--rechtsform", "-r", help="Rechtsform (z.B. GES, AG)")
    ] = None,
    api_key: Annotated[
        str | None, typer.Option("--api-key", "-k", envvar="FIRMENBUCH_API_KEY", help="API-Key")
    ] = None,
    output: Annotated[
        OutputFormat, typer.Option("--output", "-o", help="Ausgabeformat")
    ] = OutputFormat.TABLE,
    limit: Annotated[int, typer.Option("--limit", "-l", help="Max. Anzahl Ergebnisse")] = 50,
    offset: Annotated[int, typer.Option("--offset", help="Start-Offset für Ergebnisse")] = 0,
) -> None:
    """
    ...
    Beispiele:
        ...
        firmenbuchat suche firma "Software" --gericht 007 --rechtsform GES

        firmenbuchat suche firma "Mayer" -e -b 3
    """
...
@app.command("urkunde")
def urkunde(
    fnr: Annotated[str, typer.Argument(help="Firmenbuchnummer mit Prüfbuchstabe")],
    api_key: Annotated[
        str | None, typer.Option("--api-key", "-k", envvar="FIRMENBUCH_API_KEY", help="API-Key")
    ] = None,
    output: Annotated[
    ...
    Beispiele:
        ...
        firmenbuchat suche urkunde "629 a" -o json
    """
    key = resolve_api_key(api_key)
